...
namespace Afrimine.Services.BL.Implementation
{
    public class EquipmentService : IEquipmentService
    {
        ...
        public async Task<ApiResponse<SupplierProfileResponseDto>> UpdateProfileAsync(string userId, SupplierProfileUpdateDto request)
        {
            ...
            if (profile is null)
                return ApiResponse<SupplierProfileResponseDto>.Fail("Profile not found.", 404);
...
Guid supplierId, Guid bookingId, DailyCheckDto request)
        ...
        private const string ESCROW_BANK_CODE = "058";
        private const string ESCROW_ACCOUNT_NUMBER = "0138272990";
        private const string ESCROW_ACCOUNT_NAME = "GTB";
    }
}
